...
|             **[A.1.1]** **RF_FULL (Random Forest Without Simulated Annealing and Genetic Algorithms)**: Cross-Validation Accuracy = 0.77975, Test Accuracy = 0.80303 
|             **[A.1.2]** **RF_SA (Random Forest With Simulated Annealing)**: Cross-Validation Accuracy = 0.77618, Test Accuracy = 0.77272  
|             **[A.1.3]** **RF_GA (Random Forest With Genetic Algorithms)**: Cross-Validation Accuracy = 0.79842, Test Accuracy = 0.78787
|      **[A.2]** **LDA: Linear Discriminant Analysis** (<mark style="background-color: #CCECFF">**MASS**</mark> package)
|             **[A.2.1]** **LDA_FULL (Linear Discriminant Analysis Without Simulated Annealing and Genetic Algorithms)**: Cross-Validation Accuracy = 0.76754, Test Accuracy = 0.75757 
|             **[A.2.2]** **LDA_SA (Linear Discriminant Analysis With Simulated Annealing)**: Cross-Validation Accuracy = 0.80941, Test Accuracy = 0.81818  
|             **[A.2.3]** **LDA_GA (Linear Discriminant Analysis With Genetic Algorithms)**: Cross-Validation Accuracy = 0.79402, Test Accuracy = 0.84848
|
